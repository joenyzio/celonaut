...
export const NETWORKS = {
  ...
  ALFAJORES: {
    name: "alfajores",
    id: "44787",
    url: `${process.env.ALFAJORES_HOST}`,
    privKey: `${process.env.ALFAJORES_PRIV_KEY}`,
  },
};
...
export const ADDRESSES = {
  ...
  [NETWORKS.ALFAJORES.name]: "0x09902A56d04a9446601a0d451E07459dC5aF0820",
};
...
export const ACTIVE_NETWORK = NETWORKS.ALFAJORES;
